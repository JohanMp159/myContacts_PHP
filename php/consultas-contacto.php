<form action="" id="consulta-contacto" name="consulta_form" method="get">
	<fieldset>
		...
		<select name="consulta_slc" id="consulta-lista" required>
			<option value="" <?php if($_GET["consulta_slc"]=="buscador"){ echo " selected";} ?> >---</option>
			...
			<option value="pais" <?php if($_GET["consulta_slc"]=="pais"){ echo " selected";} ?> >Pais</option>
			<option value="buscador" <?php if($_GET["consulta_slc"]=="buscador"){ echo " selected";} ?> >Buscar</option>
		</select>
		<?php
...
<script>
	window.addEventListener("change",(e)=>{
		...
		if(e.target == lista){
			window.location = `?op=consultas&consulta&consulta_slc=${lista.value}`;
		}
	})
